...
![*Código fonte* é o que os programadores escrevem, e é um formato legível ao ser humano. A partir da fonte é gerado um *executável*, que é compreensível somente à máquina](images/source_machine.png)
...
![As 4 liberdades permitem que os usuários determinem os usos e o destino de um programa, mesmo aqueles que não são programadores.](images/happy_people2.png)
...
![Com software proprietário, os usuários estão a mercê dos desenvolvedores, que têm acesso exclusivo aos programas e podem usar o computador do usuário para seus próprios fins.](images/prop_software.png)
...
![Com software proprietário de fins lucrativos, principalmente os gratuitos, **você é o produto**.](images/abuse_for_profit.png)
...
![É impossível ter segurança da informação com software proprietário, pois ele sempre priorizará os interesses do seu proprietário sobre os do usuário.](images/obedece.png)
...
![Uma quantidade impressionante de detalhes sobre você é deduzida através de suas interações na web e com software -- detalhes estes que você nunca escolheu compartilhar.](images/pregnant.png)
...
![Habitantes da Federação GNU/Linux observam com pena a exploração a que os habitantes da Ditadura do Proprietário são submetidos. Felizmente, a Federação está de portas abertas!](images/slaves.png)
